...
Ask the owner for approval before using or publishing:
...
- The placeholder HVAC illustration if they want it to remain in the public version; otherwise replace it with approved business-owned imagery.

## Manual research checklist

If Facebook or other social content is not easily accessible, copy/paste these items manually from owner-approved or public pages:

- Official phone number.
- Email or preferred contact method.
- Hours.
- Service categories mentioned by the business.
- Towns or counties mentioned by the business.
- Links to public business profiles.
- A short summary of common review themes without copying review text word-for-word.
